...
1) Шлях до програми (обов'язково): file-manager.py 
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Недостатньо аргументів. Вкажіть: (1 - шлях до програми - обов'язково) file-manager.py (2 - шлях до вихідної директорії - обов'язково) <вихідна_директорія> (3 - шлях до директорії призначення - не обов'язково) <директорія_призначення>")
        exit(1)
